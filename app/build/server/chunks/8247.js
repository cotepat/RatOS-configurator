"use strict";exports.id=8247,exports.ids=[8247],exports.modules={58247:(e,r,t)=>{t.d(r,{initialPrinterCfg:()=>initialPrinterCfg,template:()=>template});let template=(e,r)=>`
...
# Config generated for ${e.printer.manufacturer} ${e.printer.name} ${Object.keys(e.size)}
...
variable_expected_camera_y_position: ${e.size.y+25}
...
${r.renderUserStepperSections({x:{directionInverted:!1,rotationComment:"40 for 20 tooth 2GT pulleys, 32 for 16 tooth 2GT pulleys",limits:r=>({min:0-r.min,max:e.size.x,endstop:0-r.min}),additionalLines:[]},y:{directionInverted:!0,rotationComment:"40 for 20 tooth 2GT pulleys, 32 for 16 tooth 2GT pulleys",limits:r=>({min:0-r.min,max:e.size.y+r.max,endstop:0-r.min})},z:{directionInverted:!0,rotationComment:"4 for TR8*4 lead screws",limits:{min:-5,max:e.size.z}},z1:{directionInverted:!1,rotationComment:"4 for TR8*4 lead screws"},extruder:{directionInverted:!0,additionalLines:["#pressure_advance: 0.05 # Check https://www.klipper3d.org/Pressure_Advance.html for pressure advance tuning.","control: pid","pid_kp: 28.413","pid_ki: 1.334","pid_kd: 151.300"]}})}
